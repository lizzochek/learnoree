<template>
    <div id="main-page">
        ...
        <div id="container">
            <div id="left-side">
                <div class="slogan">
                    <p>Empowering academic success</p>
                    <p id="slogan-2">one click at a time</p>
                </div>
                <p id="welcome-text">
                    Welcome to our educational website, where learning meets fun and engagement.
                    <br />
                    Our mission is to provide you with the tools and resources you need to unlock
                    <br />
                    your full potential and
                    achieve academic success.
                    <br />
                    Stay updated with the recent news, connect with teachers and much more!
                </p>
                <svg id="spot-1" width="648" height="437" viewBox="0 0 648 437" fill="none"
...
#spot {
    ...
    top: 15%;
    border-radius: 50%;
    background-color: var(--main-page-spots);
}
