<template>
    <div id="header">
        <div id="left-menu">
            <svg id="main-icon" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
                text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
                clip-rule="evenodd" viewBox="0 0 512 345.41">
                <path
            ...
            <router-link id="header-text" to="/main">Learnoree</router-link>
            <ColorChangeButton id="color-change"></ColorChangeButton>
        </div>
        <div id="right-menu">
            <router-link to="/my-account">
                <svg id="user-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
...
<script>
import ColorChangeButton from '../header-items/ColorChangeButton.vue';
import Menu from '../header-items/Menu.vue';
